<template>
  <div ref="el" class="my-20">
    <div class="my-10 mx-10 sm:my-20 md:mx-40">
      ...
      <p class="text-base md:text-lg lg:text-xl mb-8 mt-8">
      ...
      <p class="text-base md:text-lg lg:text-x mb-4 mt-4">
    ...
    <div class="flex flex-col md:flex-row md:justify-around items-center mt-20 space-y-10">
      <div class="space-y-8">
        <p class="text-center">
